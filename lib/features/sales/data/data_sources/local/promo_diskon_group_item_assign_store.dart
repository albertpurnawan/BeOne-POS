...
class PromoDiskonGroupItemAssignStoreDao
    extends BaseDao<PromoDiskonGroupItemAssignStoreModel> {
  ...
  @override
  Future<PromoDiskonGroupItemAssignStoreModel?> readByDocId(
    ...
    return res.isNotEmpty
        ? PromoDiskonGroupItemAssignStoreModel.fromMap(res[0])
        : null;
  }

  @override
  Future<List<PromoDiskonGroupItemAssignStoreModel>> readAll(
    ...
    if (txn != null) {
      ...
      return result
          .map((itemData) =>
              PromoDiskonGroupItemAssignStoreModel.fromMap(itemData))
          .toList();
    } else {
  ...
  Future<PromoDiskonGroupItemAssignStoreModel> readByTodgId(
