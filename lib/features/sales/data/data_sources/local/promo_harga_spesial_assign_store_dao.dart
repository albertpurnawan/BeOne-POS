...
class PromoHargaSpesialAssignStoreDao extends BaseDao<PromoHargaSpesialAssignStoreModel> {
  ...
  @override
  Future<PromoHargaSpesialAssignStoreModel?> readByDocId(String docId, Transaction? txn) async {
  ...
  @override
  Future<List<PromoHargaSpesialAssignStoreModel>> readAll({Transaction? txn}) async {
    DatabaseExecutor dbExecutor = txn ?? db;
