...
class PromoMultiItemAssignStoreDao
    extends BaseDao<PromoBonusMultiItemAssignStoreModel> {
  ...
  @override
  Future<PromoBonusMultiItemAssignStoreModel?> readByDocId(
    ...
    return res.isNotEmpty
        ? PromoBonusMultiItemAssignStoreModel.fromMap(res[0])
        : null;
  }

  @override
  Future<List<PromoBonusMultiItemAssignStoreModel>> readAll(
