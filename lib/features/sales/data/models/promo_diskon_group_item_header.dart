...
const tablePromoDiskonGroupItemHeader = "topdg";

class PromoDiskonGroupItemHeaderFields {
...
class PromoDiskonGroupItemHeaderModel extends PromoDiskonGroupItemHeaderEntity
  ...
  PromoDiskonGroupItemHeaderModel({
  ...
  factory PromoDiskonGroupItemHeaderModel.fromMap(Map<String, dynamic> map) {
    return PromoDiskonGroupItemHeaderModel(
  ...
  factory PromoDiskonGroupItemHeaderModel.fromMapRemote(
      Map<String, dynamic> map) {
    return PromoDiskonGroupItemHeaderModel.fromMap({
      ...map,
  ...
  factory PromoDiskonGroupItemHeaderModel.fromEntity(
      PromoDiskonGroupItemHeaderEntity entity) {
    return PromoDiskonGroupItemHeaderModel(
      docId: entity.docId,
