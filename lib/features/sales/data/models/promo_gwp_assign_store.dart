...
import 'package:pos_fe/features/sales/domain/entities/promo_gwp_assign_store.dart';

const String tablePromoGWPAssignStore = "tprg2";

class PromoGWPAssignStoreFields {
...
class PromoGWPAssignStoreModel extends PromoGWPAssignStoreEntity
    implements BaseModel {
  PromoGWPAssignStoreModel({
  ...
  factory PromoGWPAssignStoreModel.fromMap(Map<String, dynamic> map) {
    return PromoGWPAssignStoreModel(
  ...
  factory PromoGWPAssignStoreModel.fromMapRemote(Map<String, dynamic> map) {
    return PromoGWPAssignStoreModel.fromMap({
      ...map,
  ...
  factory PromoGWPAssignStoreModel.fromEntity(
      PromoGWPAssignStoreEntity entity) {
    return PromoGWPAssignStoreModel(
      docId: entity.docId,
