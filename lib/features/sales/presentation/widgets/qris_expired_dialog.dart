...
class QRISExpiredDialog extends StatefulWidget {
  const QRISExpiredDialog({super.key});

  @override
  State<QRISExpiredDialog> createState() => _QRISExpiredDialogState();
}

class _QRISExpiredDialogState extends State<QRISExpiredDialog> {
  @override
