...
class PromoDiskonGroupItemHeaderEntity {
  ...
  factory PromoDiskonGroupItemHeaderEntity.fromMap(Map<String, dynamic> map) {
    return PromoDiskonGroupItemHeaderEntity(
  ...
  factory PromoDiskonGroupItemHeaderEntity.fromJson(String source) =>
      PromoDiskonGroupItemHeaderEntity.fromMap(
  ...
  @override
  bool operator ==(covariant PromoDiskonGroupItemHeaderEntity other) {
