...
class VendorEntity {
  ...
  @override
  String toString() {
    return 'VendorEntity(docId: $docId, createDate: $createDate, updateDate: $updateDate, vendCode: $vendCode, vendName: $vendName, tovdgId: $tovdgId, idCard: $idCard, taxNo: $taxNo, gender: $gender, birthdate: $birthdate, addr1: $addr1, addr2: $addr2, addr3: $addr3, city: $city, toprvId: $toprvId, tocryId: $tocryId, tozcdId: $tozcdId, phone: $phone, email: $email, remarks: $remarks, toptrId: $toptrId, toplnId: $toplnId, maxDiscount: $maxDiscount, statusActive: $statusActive, activated: $activated, tohemId: $tohemId, sync: $sync)';
  }
