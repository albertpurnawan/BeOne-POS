...
class PromoBuyXGetYAssignStoreEntity {
  ...
  @override
  String toString() {
    return 'PromoBuyXGetYAssignStoreEntity(docId: $docId, createDate: $createDate, updateDate: $updateDate, toprbId: $toprbId, tostrId: $tostrId, holiday: $holiday, day1: $day1, day2: $day2, day3: $day3, day4: $day4, day5: $day5, day6: $day6, day7: $day7, form: $form)';
  }
