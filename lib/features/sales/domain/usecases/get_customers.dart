...
class GetCustomersUseCase implements UseCase<List<CustomerEntity>, GetCustomersUseCaseParams?> {
  ...
  Future<List<CustomerEntity>> call({GetCustomersUseCaseParams? params}) {
    return _customerRepository.getCustomers(searchKeyword: params?.searchKeyword, statusActive: params?.statusActive);
  }
}
