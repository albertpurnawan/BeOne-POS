...
class HandleOpenPriceUseCase implements UseCase<ReceiptItemEntity, HandleOpenPriceUseCaseParams?> {
  ...
  Future<ReceiptItemEntity> call({HandleOpenPriceUseCaseParams? params}) async {
    try {
      ...
      return ReceiptHelper.updateReceiptItemAggregateFields(params.receiptItemEntity.copyWith(
        itemEntity: params.receiptItemEntity.itemEntity.copyWith(
            ...
            dpp: params.receiptItemEntity.itemEntity.includeTax == 1
                ? params.newPrice * (100 / (100 + params.receiptItemEntity.itemEntity.taxRate))
                : params.newPrice),
