...
class ApplyPromoTopdiUseCase
    implements UseCase<ReceiptEntity, ApplyPromoTopdiUseCaseParams> {
    ...
    try {
      ...
      final SplitListResult<ReceiptItemEntity> splitListResult =
        ...
        3 || 4 => Helpers.splitList<ReceiptItemEntity>(
            receiptEntity.receiptItems,
            (receiptItem) => params.topdiHeaderAndDetail.tpdi1
                .where((e) => e.toitmId == receiptItem.itemEntity.toitmId)
                .isNotEmpty),
        _ => SplitListResult([], [])
      };

      final List<ReceiptItemEntity> matchedReceiptItems =
      ...
      if (topdi.promoValue > 0) {
        ...
        // apply promo
        final double discValuePctg = topdi.promoValue /
        ...
        final double totalChainOfDiscountPctg = 1 -
            ((1 - (topdi.discount1 / 100)) *
                (1 - (topdi.discount2 / 100)) *
                (1 - (topdi.discount3 / 100)));
