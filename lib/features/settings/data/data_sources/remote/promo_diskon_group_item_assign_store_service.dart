  ...
  Future<List<PromoDiskonGroupItemAssignStoreModel>> fetchData(
    ...
    try {
      ...
      if (resp.data['data'].isNotEmpty) {
        log("--- PROMO DISKON GROUP ITEM - ASSIGN STORE ---");
        ...
        List<PromoDiskonGroupItemAssignStoreModel> data = (resp.data['data']
                as List)
            .map((e) => PromoDiskonGroupItemAssignStoreModel.fromMapRemote(e))
            .toList();
        allData.addAll(data);
      }
